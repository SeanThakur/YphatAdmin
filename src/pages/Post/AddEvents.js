...
import { setEventsActivitiesInfo } from 'src/feature/actions';
...
const AddEvents = () => {
    ...
    const handleSubmit = (values, {setSubmitting}) => {
        ...
        if(awsImage.length > 0) {
            ...
            dispatch(setEventsActivitiesInfo(data, navigate));
            console.log(data)
        } else {
    ...
    return (
        <>
        <Helmet>
            <title>Add Events/Activity | Yapth</title>
        </Helmet>
        <Box
            sx={{
                    ...
                    <Grid container spacing={1}>
                        ...
                        <Grid item md={12} xs={12}>
                            ...
                            <RadioGroup row name="type" value={values.type} onChange={(event) => {
                                ...
                                <FormControlLabel value="activity" control={<Radio color="primary" />} label="Activity" />
                            </RadioGroup>
                        </Grid>
                        <Grid
                            item
