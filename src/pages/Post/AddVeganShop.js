...
import { setVeganShopDetail } from 'src/feature/actions';
...
const AddVeganShop = () => {
    ...
    const handleSubmit = (values, {setSubmitting}) => {
        ...
        if(awsImage.length > 0) {
            ...
            dispatch(setVeganShopDetail(data, navigate));
            console.log(data)
        } else {
    ...
    return (
        <>
        <Helmet>
            <title>Add Vegan/Shop | Yapth</title>
        </Helmet>
        <Box
            sx={{
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Grid container spacing={1}>
                        ...
                        <Grid item md={12} xs={12}>
                            ...
                            <RadioGroup row name="type" value={values.type} onChange={(event) => {
                                setFieldValue('type', event.currentTarget.value)
                            }}>
                                <FormControlLabel value="shop" control={<Radio color="primary" />} label="Shop" />
                                <FormControlLabel value="vegan" control={<Radio color="primary" />} label="Vegan" />
                            </RadioGroup>
                        </Grid>
                        <Grid
                            item
